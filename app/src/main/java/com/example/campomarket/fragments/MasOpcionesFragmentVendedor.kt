...
class MasOpcionesFragmentVendedor : Fragment (){

    private lateinit var opcionCompras : LinearLayout
    private lateinit var opcionVentas : LinearLayout
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_mas_opciones_vendedor, container, false)
        ...
        opcionVentas = view.findViewById(R.id.opcionVentas)
        opcionVentas.setOnClickListener{
            findNavController().navigate(R.id.misVentasFragment)
        }
